...
out_count_non_null = out_count[(out_count != None) & (out_count != "None") & (out_count != "NULL") & pd.notna(out_count)]
...
is_anything_left = in_count_non_null[(in_count != "`in_count`")]
print("After removing nulls and placeholders from in_count: ", is_anything_left)

is_anything_left_out_count = out_count_non_null[(out_count != "`out_count`")]
print("After removing nulls and placeholders from out_count: ", is_anything_left_out_count)